...
class MemTransformerLM(nn.Module):
    def __init__(self, n_token, n_inst, n_layer, n_head, d_model, d_head, d_inner,
        ...
        self.i_emb = torch.nn.Embedding(n_inst, d_model)
    ...
    # _forward: internal forward function
    # ARGUMENTS
    ...
    def _forward(self, dec_inp, inst, mems=None):
        ...
        # NxBxD
        word_emb = self.word_emb(dec_inp) + torch.tanh(self.i_emb(inst)).view(1, bsz, -1).expand(qlen, -1, -1)
    ...
    # target: the target message sequence
    # mems: positional arguments containing the embeddings and hidden states from a previous
    # chunk (if any, otherwise None)
